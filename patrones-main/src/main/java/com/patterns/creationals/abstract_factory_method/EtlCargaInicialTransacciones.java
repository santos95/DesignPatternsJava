...
public class EtlCargaInicialTransacciones implements EtlCargaInicial{
    @Override
    public void ejecutarEtl() {
        ...
        System.out.printf("%s INFO - Registros insertados encabezado 25000\n", now);
        now = LocalDateTime.now();
        System.out.printf("%s INFO - Total Registros Insertados Encabezado (SIE): 200000\n", now);
        now = LocalDateTime.now();
        ...
        System.out.printf("%s INFO - Registros insertados Detalle 25000\n", now);
        now = LocalDateTime.now();
        System.out.printf("%s INFO - Registros Insertados Detalle (sie): 500000\n", now);
        now = LocalDateTime.now();
